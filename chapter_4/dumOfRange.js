...
// Next, write a sum function that takes an array of numbers and returns the sum of these numbers. Run the example p
// rogram and see whether it does indeed return 55.
...
function range(num_1, num_2, step = 0){
    let arr = []
    num_2 = num_2 + step
    if(num_1 < num_2) {
...
function sum(func) {
    return func.reduce((acc, val) => acc + val, 0)
}